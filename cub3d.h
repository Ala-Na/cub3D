...
/*   Updated: 2022/01/14 18:54:16 by anadege          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERROR_COLOUR_TOO_MANY	"ERROR\nToo many argument to define colour\n"
# define ERROR_NO_COLOUR		"ERROR\nNot enough argument to define colour\n"
...
# define PITCH	100
# define MOVE	0.3333333333
# define ROTATE	0.3926990816
...
void	show_textured_wall(t_data *data, t_ray *ray,
			t_stripe *stripe, t_img *img);
int		get_corresponding_pixel_color(t_stripe *stripe,
			t_img *texture, double scale);
...
void	fill_img_buffer(t_data *data, t_img *img, t_ivec *pos,
